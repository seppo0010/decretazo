...
ARTICULO 1º — Objeto. La presente ley tiene por objeto establecer el régimen de trazabilidad de los productos médicos activos, la trazabilidad metrológica de los mismos, y la creación o fortalecimiento de los Servicios de Tecnología Biomédica en todo el territorio nacional.
...
ARTICULO 5º — Tipos y clasificación de los productos médicos activos. Los productos médicos activos, objeto de esta ley, se agrupan según el riesgo intrínseco que representan para la salud del consumidor, paciente, operador o terceros involucrados, en clases I, II, III o IV. Las mismas se clasifican de acuerdo a la finalidad de cada producto médico activo y según las reglas establecidas en la disposición 2.318/2002, texto ordenado según disposición 1.285/2004, de la Administración Nacional de Medicamentos, Alimentos y Tecnología Médica, ANMAT, o la que en un futuro se dicte.

ARTICULO 5º bis — La Autoridad de Aplicación determinará los productos médicos activos autorizados para su uso en el territorio nacional. No podrán ser utilizados los productos activos que no hayan sido autorizados por la Autoridad de Aplicación.

(Artículo incorporado por art. 303 del Decreto N° 70/2023 B.O. 21/12/2023.)

ARTICULO 5º ter — Los usuarios de productos médicos activos deberán informar la instalación y uso de los mismos a la autoridad de aplicación. La Autoridad de Aplicación determinará los requisitos y procedimientos para el uso de productos médicos activos. Y se reserva el derecho de auditar su cumplimiento.
...
ARTICULO 9º — Requisitos. La autorización de uso se debe otorgar en forma individual a cada producto médico activo, cuando sea ensayado según las normas técnicas aplicables.
...
ARTICULO 10. — Vigencia. La autoridad jurisdiccional debe definir la duración de los certificados de habilitación de los productos médicos activos, según su riesgo intrínseco para la salud y de acuerdo a lo establecido en el artículo 5° de la presente ley.
...
a) Entregar copias completas, originales y en idioma español, de los manuales de uso y mantenimiento, y de toda información complementaria, que le sean requeridos por la autoridad de aplicación, los Servicios de Tecnología Biomédica o los laboratorios mencionados en el artículo 9°;
...
ARTICULO 18. — Nivel de cualificación. Todos los prestadores de los servicios de reparaciones y mantenimiento de los productos médicos activos deben contar con un responsable técnico, el cual deberá ser un profesional de la ingeniería con título habilitante para su ejercicio y matriculado, con incumbencia en la materia.

ARTICULO 19. — Inscripción y habilitación. La autoridad de aplicación, en coordinación con la autoridad jurisdiccional establecerá el plazo y la forma, en que los Prestadores de Servicios de Reparaciones y Mantenimiento de los productos médicos activos, deben inscribirse en el registro correspondiente.
...
ARTICULO 20. — Instrumental. El instrumental de funcionamiento preciso que se utilice en pruebas específicas debe contar con el respaldo documental de su calibración vigente realizada en organismo reconocido o mediante las certificaciones de pruebas exigidas por los fabricantes.
